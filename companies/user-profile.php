...
<head>
    ...
    <title>Company Profile - Eduwide</title>
                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active profile-overview pt-3" id="profile-overview">
                                   <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Company Profile Picture</div>
                                    ...
                                    <div class="container">
                                        <form action="update-socialmedia.php" method="POST">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-lg-3 col-md-4 label">Cmmpany Website<i class="bi bi-globe"></i></div>
                                                <div class="col-lg-9 col-md-8">
                                                    <div class="d-flex">
