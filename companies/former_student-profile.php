                                            ...
                                            <?php foreach ($experiences as $exp): ?>
                                                <li class="timeline-item">
                                                    <div>
                                                        ...
                                                        <p><strong>Period:</strong> <?= htmlspecialchars($exp['start_month']) ?> <?= htmlspecialchars($exp['start_year']) ?> - <?= htmlspecialchars($exp['end_month']) ?> <?= htmlspecialchars($exp['end_year']) ?></p>
