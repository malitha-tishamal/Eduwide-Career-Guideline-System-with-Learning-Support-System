...
// Fetch subjects for Semester II
$sql = "SELECT * FROM subjects WHERE semester = 'Semester III'";
...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="">Semester III</a></li>
                </ol>
            </nav>
        </div>
        ...
        <section class="section">
            ...
            <a href="pages-semester4.php" class="btn btn-primary mt-3">Next: Semester IV</a>  
        </section>
    </main>
