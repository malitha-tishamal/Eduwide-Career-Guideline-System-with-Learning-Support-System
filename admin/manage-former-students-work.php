...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Manage Former Students (Full Time Work)</h1>
            <nav>
                <ol class="breadcrumb">
      ...
      document.addEventListener('DOMContentLoaded', function () {
        ...
        approveButtons.forEach(button => {
            button.addEventListener('click', function () {
                ...
                window.location.href = `process-former-students-work.php?approve_id=${userId}`;
            });
        });
        ...
        disableButtons.forEach(button => {
            button.addEventListener('click', function () {
                const userId = this.getAttribute('data-id');
                window.location.href = `process-former-students-work.php?disable_id=${userId}`;
            });
        });
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', function () {
                ...
                if (confirm("Are you sure you want to delete this user?")) {
                    window.location.href = `process-former-students-work.php?delete_id=${userId}`;
                }
            });
        });
      });
