...
$sql = "SELECT subjects.* FROM subjects
        ...
        WHERE lectures_assignment.lecturer_id = ? AND subjects.semester = 'Semester I'";
$stmt = $conn->prepare($sql);
$stmt->bind_param("i", $user_id);
$stmt->execute();
$result = $stmt->get_result();
...
<head>
    ...
    <title>Semester 1 - EduWide</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <section class="section">
                ...
                <a href="pages-semester2.php" class="btn btn-primary mt-3">Next: Semester II</a>
