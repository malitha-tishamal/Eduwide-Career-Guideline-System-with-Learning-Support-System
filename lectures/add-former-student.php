                    ...
                    <div class="card">
                        <div class="card-body pt-4">
                            ...
                            <form action="former-student-register-process2.php" method="POST" class="needs-validation" novalidate>
                                ...
                                <div class="row mb-3">
                                    <label for="name" class="col-lg-3 col-md-4 col-sm-4 col-form-label">Now Full Time Status</label>
                                    <div class="col-lg-9 col-md-8 col-sm-8">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#signup-form").submit(function(event) {
                ...
                $.ajax({
                    url: "former-student-register-process2.php", // Send form data to register.php
                    type: "POST",
